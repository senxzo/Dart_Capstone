...
import 'package:stressed_out/pages/analyze/stress_analyzer.dart';
import 'package:stressed_out/pages/components/common_components.dart';
import 'package:stressed_out/pages/event/create_event.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  final pages = [const EventList(), const AnalyzeList(), const PostList()];

  final fabPages = [CreateEvent(), StressAnalyzer(), CreatePost()];

  final fabIcons = [Icons.add, Icons.analytics_outlined, Icons.add];
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => fabPages[activeNavIndex],
              ),
            );
          },
          child: Icon(fabIcons[activeNavIndex]),
        ),
      ),
    );
  }

  // This is to return nav bar items with titles.
